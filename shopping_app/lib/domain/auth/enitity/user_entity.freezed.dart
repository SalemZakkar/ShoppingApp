...
class _$_UserEntity implements _UserEntity {
  ...
  @override
  String toString() {
    return 'UserEntity(id: $id, name: $name, email: $email, img: $img, gender: $gender)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, name, email, img, gender);
...
abstract class _UserEntity implements UserEntity {
  const factory _UserEntity(
      ...
      required final String gender}) = _$_UserEntity;
